  ...
  "eye-off": ({ color, stroke }) => (
    <>
      ...
      <Path
        ...
        stroke={color} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
      />
      <Line x1="1" y1="1" x2="23" y2="23" stroke={color} strokeWidth={stroke} strokeLinecap="round" />
    </>
  ),
  "alert-circle": ({ color, stroke }) => (
    <>
      <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={stroke} />
      <Line x1="12" y1="8" x2="12" y2="12" stroke={color} strokeWidth={stroke} strokeLinecap="round" />
      <Line x1="12" y1="16" x2="12.01" y2="16" stroke={color} strokeWidth={stroke + 0.5} strokeLinecap="round" />
    </>
  ),
